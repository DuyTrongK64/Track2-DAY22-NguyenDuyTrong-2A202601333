...
class PIIDetector(Validator):
    ...
    def validate(self, value: str, metadata: dict):
        ...
        (được Guardrails tự động fix khi dùng OnFailAction.FIX).
        """
        redacted_text = value
        found_pii     = []
...
class JSONFormatter(Validator):
    ...
    def _repair(text: str) -> str:
        ...
        # Thay single quotes → double quotes cho JSON
    ...
    def validate(self, value: str, metadata: dict):
        ...
        Trả về PassResult nếu hợp lệ từ đầu.
        Trả về FailResult với fix_value nếu đã sửa hoặc fallback nếu không thể sửa.
        """
        try:
            json.loads(value)
            return PassResult()
